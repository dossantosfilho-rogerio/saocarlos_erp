<div class="space-y-4 sm:space-y-6">
    ...
    {{-- Cabeçalho da página --}}
    <div>
        <h2 class="text-lg font-bold text-[#1A3A0A] sm:text-xl">Visão Geral</h2>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
        ...
        {{-- Vendas da Semana --}}
        <div class="bg-white rounded-xl border border-[#E0D8C8] shadow-sm p-4 sm:p-5 flex items-start gap-4">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-7 gap-3">
            ...
            @foreach($shortcuts as $sc)
                <a href="{{ route($sc['route']) }}"
                   class="{{ $sc['color'] }} rounded-xl p-3 sm:p-4 flex flex-col items-center gap-2 text-white hover:brightness-110 transition shadow-sm hover:shadow-md">
                    @if($sc['icon'] === 'cart')
    ...
    <div class="bg-white rounded-xl border border-[#E0D8C8] shadow-sm p-4 sm:p-6 flex items-start gap-4">
